...
import com.example.mibibliotecamusical.databinding.ItemHomePlaylistsBinding
...
class PlaylistListAdapter: ListAdapter<Playlist, RecyclerView.ViewHolder>(PlaylistDiffCallback())
{
    ...
    {
        val binding = ItemHomePlaylistsBinding.bind(view)
    }
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder
    {
        ...
        val view = LayoutInflater.from(context).inflate(R.layout.item_home_playlists, parent, false)
